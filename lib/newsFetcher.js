...
export async function fetchTopNews() {
  ...
  const url = `${BASE_URL}?apikey=${NEWSDATA_API_KEY}&q=Mutual%20Fund%20Industry%20OR%20Finance%20OR%Fixed%20Income%20Instruments&country=in&language=en&timezone=Asia/Kolkata`;
